...
export default function FrontSection({ isOpen }: isOpenType) {
  return (
    <div
      className={`${isOpen && "open"} cardFront relative h-full w-full origin-left overflow-hidden bg-red-600 transition-all duration-500`}
    >
      {!isOpen && (
        <>
          <div
            className={`front-text absolute bottom-0 w-full -translate-y-1/2 text-center text-white`}
          >
